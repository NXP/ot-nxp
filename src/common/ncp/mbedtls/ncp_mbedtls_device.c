...
int ncp_sys_encrypt(void *tlv)
{
    ...
    NCPCmd_DS_SYS_COMMAND *cmd_res = (NCPCmd_DS_SYS_COMMAND *)ncp_get_ot_response_buffer();
    ...
    system_ncp_send_response((uint8_t *)cmd_res);
