...
- Download [IMXRT1060 SDK 2.11.1](https://mcuxpresso.nxp.com/). Creating an
  ...
  SDK_2.11.1_MIMXRT1060-EVKB (or SDK_2.11.1_EVK-MIMXRT1060 if you have
  EVK-MIMXRT1060 board). In the SDK Builder UI selection you should select the
  **FreeRTOS component**, the **BT/BLE component** and the **ARM GCC
  Toolchain**.
