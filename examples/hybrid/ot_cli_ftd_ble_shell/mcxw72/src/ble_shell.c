...
static shell_command_t mGapCmd = {
    ...
    .pcHelpString =
        ...
        "  gap scancfg [-type type] [-interval intervalInMs] [-window windowInMs] [-phy scanningPhy] [-duration "
        "durationInMs] [-period periodInMs] [-filter filterPolicy]\r\n"
#else
        "  gap scancfg [-type type] [-interval intervalInMs] [-window windowInMs] [-phy scanningPhy] [-duration "
        "durationInMs] [-period periodInMs]\r\n"
        ...
        "  gap extadvstart\r\n"
        "  gap extadvstop\r\n"
        "  gap extadvcfg [-min minIntervalInMs] [-max maxIntervalInMs] [-type advProperties] [-phy1 primaryPHY] [-phy2 "
        "secondaryPHY] [-tx advTxPower] [-sn enableScanNotification]\r\n"
        ...
        "[-advacheck advACheck] [-add1type advAAddress1Type] [-add1 advAAdress1] [-add2type advAAddress2Type] [-add2 "
        "advAAdress2] "
        "[-advmode advMode]\r\n"
        "  gap deldecinstr\r\n"
        "  gap extadvdecdata [-key key] [-prand rand] [-decdata decisionData] [-datalen dataLength] [-restag "
        "resolvableTagPresent]\r\n"
#endif /* BLE_SHELL_DBAF_SUPPORT */
    ,
...
static shell_command_t mThrputCmd = {.pcCommand = "thrput",
                                     .pcHelpString =
                                         "\"thrput\": Contains commands for setting up and running throughput test\r\n"
...
static shell_command_t mResetCmd = {.pcCommand                   = "reset",
...
#if (defined(CPU_MKW37A512VFT4) || defined(CPU_MKW38A512VFT4))
#if (defined(gRFCalibration_d) && (gRFCalibration_d > 0))
static cmd_tbl_t mCalibrationCmd = {.name       = "calibration",
                                    .maxargs    = 4,
                                    .repeatable = 0,
                                    .cmd        = ShellCalibration_Command,
                                    .usage      = (char *)mpCalibrationHelp,
                                    .help =
                                        "Enalbe/Disable RF calibration. Set/Get frequency trim and RSSI adjustment"};
...
static const thrCmds_t mCalibrationShellCmds[] = {
    {"enable", ShellCalibration_EnableRFCalibration},   {"getxtaltrim", ShellCalibration_GetXtal32MHzTrim},
    {"setxtaltrim", ShellCalibration_SetXtal32MHzTrim}, {"getrssiadj", ShellCalibration_GetRssiAdjustment},
