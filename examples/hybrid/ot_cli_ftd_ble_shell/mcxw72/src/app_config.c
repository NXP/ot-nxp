...
gapAdvertisingData_t gAppAdvertisingData = {0, mAdStructures};

gapAdvertisingData_t gAppExtAdvertisingData = {0, mExtAdStructures};
...
gapScanResponseData_t gAppExtScanRspData = {0, mScanAdStructures};
...
gapAdvertisingDecisionData_t gAppExtAdvDecisionData = {.pKey                 = gaDecisionKey,
                                                       .pPrand               = gaPrand,
...
gapScanningParameters_t gAppScanParams = {
    /* type */ gScanTypePassive_c,          /* interval */ gGapScanIntervalDefault_d,
    /* window */ gGapScanWindowDefault_d,   /* ownAddressType */ gBleAddrTypePublic_c,
    /* filterPolicy */ (uint8_t)gScanAll_c, /* scanning PHY */ (uint8_t)gLePhy1MFlag_c};
...
/* LTK */
static uint8_t smpLtk[mcEncryptionKeySize_c] = {0xD6, 0x93, 0xE8, 0xA4, 0x23, 0x55, 0x48, 0x99,
