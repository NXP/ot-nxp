...
#define shell_writeDec(a) \
    (void)SHELL_PrintfSynchronization((shell_handle_t)g_shellHandle, (const char *)FORMAT_Dec2Str(a))
#define shell_writeBool(a)                                                         \
    if (a)                                                                         \
    {                                                                              \
        (void)SHELL_PrintfSynchronization((shell_handle_t)g_shellHandle, "TRUE");  \
    }                                                                              \
    else                                                                           \
    {                                                                              \
        (void)SHELL_PrintfSynchronization((shell_handle_t)g_shellHandle, "FALSE"); \
    }
#define shell_writeHex(a) \
    (void)SHELL_PrintfSynchronization((shell_handle_t)g_shellHandle, (char const *)FORMAT_Hex2Ascii(a))
...
#define SHELL_THRPUT_TIMEOUT_MS \
    (3U * ((uint32_t)gGapDefaultMaxConnectionInterval_d + (uint32_t)gGapDefaultMaxConnectionInterval_d / 4U))
#endif
/************************************************************************************
*************************************************************************************
* Public prototypes
