...
*
* example:
*  UUID128(uuid_service_robot_characteristics, 0x12, 0x34, 0x56, 0x78, 0x90, 0xAB, 0xCD, 0xEF, 0x12, 0x34, 0x56, 0x78,
0x90, 0xAB, 0xCD, 0xEF)
*  UUID128(uuid_char_robot_direction, 0x12, 0x34, 0x50, 0x00, 0x90, 0xAB, 0xCD, 0xEF, 0x12, 0x34, 0x56, 0x78, 0x90,
0xAB, 0xCD, 0xEF)
*
*/
/* Services */

UUID128(uuid_service_throughput,
        0xE0,
        0x1C,
        0x4B,
        0x5E,
        ...
        0xFF,
        0x01)
UUID128(uuid_throughput_stream,
        0xE0,
        0x1C,
        0x4B,
        0x5E,
