 ...
 * \param buffer
 * \param buf_length
 * \return int  0 if file does not exist (The file is created), buffer is not modified
 ...
 *          Call @ref FS_ReadBufferFromFile() to create the file or Refer to lfs.h API for error code
 */
